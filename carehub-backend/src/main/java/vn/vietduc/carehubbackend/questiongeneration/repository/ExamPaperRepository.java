...
public interface ExamPaperRepository extends JpaRepository<ExamPaper, Long> {
    ...
    List<ExamPaper> findByIdempotencyKeyOrderByVersionAsc(String idempotencyKey);

    List<ExamPaper> findByGenerationBatchOrderByVariantIndexAsc(ExamPaperGenerationBatch generationBatch);

    long countByGenerationBatchId(Long generationBatchId);
