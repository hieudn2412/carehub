...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "paraphrase_candidates")
public class ParaphraseCandidate extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "job_id", nullable = false)
    private ParaphraseJob job;
    ...
    @Column(name = "semantic_similarity_to_source")
    private Double semanticSimilarityToSource;

    @Column(name = "lexical_difference_from_source")
    private Double lexicalDifferenceFromSource;
