...
@Table(
        ...
        uniqueConstraints = {
                @UniqueConstraint(
                        name = "uq_exam_attempt_questions_question",
                        columnNames = {"attempt_id", "paper_question_id"}
                ),
                @UniqueConstraint(
                        name = "uq_exam_attempt_questions_position",
                        columnNames = {"attempt_id", "position"}
                )
        }
)
public class ExamAttemptQuestion extends BaseEntity {
