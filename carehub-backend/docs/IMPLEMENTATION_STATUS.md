...
- The legacy question-set exam-config path (and the "Bộ câu hỏi" feature it backed) has been removed entirely; all exam configs use the direct field×cognitive blueprint. Assignment creation requires both the audience and direct-generation gates.
