...
const PAGE_TITLE_ROUTES = [
  ...
  ['/admin/evaluation/exam-management/assignments/:assignmentId/paper/:paperId', 'Xem mã đề'],
  ...
  ['/admin/evaluation/competency-summary', 'Năng lực chuyên môn'],
  ...
  ['/manager/competency-summary', 'Năng lực chuyên môn'],
