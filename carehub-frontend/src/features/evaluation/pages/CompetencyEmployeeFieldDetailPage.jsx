          ...
          <main className="dashboard-body">
            <div className="evd-page">
              <div style={{ marginBottom: 16 }}>
                <button className="evd-btn-text" onClick={() => navigate(-1)} style={{ fontSize: 14, padding: '8px 0' }}>
                  ...
                  <tbody>
                    {loading ? (
                      ...
                      data.items.map((item, idx) => (
                        <tr key={idx} className={!item.isPassed ? 'evd-row--danger' : ''}>
