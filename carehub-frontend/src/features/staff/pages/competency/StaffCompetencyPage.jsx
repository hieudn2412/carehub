...
import { CheckCircleFilled, CloseOutlined, EyeOutlined, LoadingOutlined, SafetyCertificateOutlined, WarningFilled } from '@ant-design/icons'
  ...
  return (
    <div className="dashboard-layout">
      ...
      <div className="dashboard-layout__content">
        <Header breadcrumbs={[{ label: 'Tuân thủ quy trình, quy định' }]} />
        <div className="dashboard-root"><main className="dashboard-body"><div className="sc-page">
          ...
          <div className="sc-content">
            {loading ? <div className="sc-loading"><LoadingOutlined spin /> Đang tải dữ liệu...</div> : !(data?.items?.length) ? <div className="sc-empty">Chưa có lượt đánh giá trong khoảng thời gian này.</div> : (
      ...
      {detail !== null ? <div className="sc-detail-backdrop" role="presentation" onMouseDown={() => setDetail(null)}><section className="sc-detail-dialog" role="dialog" aria-modal="true" onMouseDown={event => event.stopPropagation()}>
        ...
        {detailLoading ? <div className="sc-detail-dialog__loading"><LoadingOutlined spin /> Đang tải...</div> : <div className="sc-detail-dialog__body">
